...
== Lab 3. Why address risk & security frameworks?
...
=== 3.1  Governance, Risk, and Compliance (aka GRC)
...
== 3.5 How do you pick the right framework?
...
== 3.6 How is the NIST CSF Connected with RHEL Hardening?
...
=== 3.6.2 Red Hat Enterprise Linux (RHEL) 9 Security Technical Implementation Guide (STIG)
