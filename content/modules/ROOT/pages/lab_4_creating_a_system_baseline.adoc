...
=== 4.1 Installing the sos package from the command line
...
=== 4.2 Generating an sos report from the command line
...
=== 4.2.1 (Optional) If you have already opened a Technical Support case with Red Hat,
...
=== 4.3 Take note of the sos report file name displayed at the end of the console output.

i.e. /var/tmp/sosreport-bastion-2024-04-15-outurcc.tar.xz

=== 4.4 Cleaning an sos report
...
=== 4.5 Capturing Ports, Protocalls, and Services with Anisble
...
Building on the past directories we have set up our ansible working directorym we are going to create a new file using vi.
